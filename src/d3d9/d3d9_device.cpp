...
namespace dxvk {
  ...
  DxvkDeviceFeatures D3D9DeviceEx::GetDeviceFeatures(const Rc<DxvkAdapter>& adapter) {
    ...
    enabled.core.features.shaderStorageImageExtendedFormats    = supported.core.features.shaderStorageImageExtendedFormats;
    ...
    // SM2 level hardware
    enabled.core.features.occlusionQueryPrecise = enabled.core.features.occlusionQueryPrecise;
